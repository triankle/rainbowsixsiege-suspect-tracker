...
const verdictSchema = z.enum(['clean', 'smurf', 'suspect', 'uncertain']);
...
const analysisInputSchema = z.object({
  ...
  winrate: z
    .union([z.literal(''), z.null(), z.undefined(), z.coerce.number().finite().min(0).max(100)])
...
const submissionSchema = analysisInputSchema.extend({
...
const entriesQuerySchema = z
  .object({
    ...
    pseudo: nullableTrimmedString(80).optional().default(null),
    verdict: z.union([verdictSchema, z.literal(''), z.null(), z.undefined()]).transform((value) => value || null).default(null),
    rank: nullableTrimmedString(32).optional().default(null),
    minScore: z
      .union([z.literal(''), z.null(), z.undefined(), z.coerce.number().finite().min(0).max(100)])
      .transform((value) => (value === '' || value === null || value === undefined ? null : Number(value)))
      .default(null),
    sort: z.enum(['createdAt', '-createdAt', 'cheatScore', '-cheatScore', 'smurfScore', '-smurfScore']).default('-createdAt'),
  })
  .strict();
